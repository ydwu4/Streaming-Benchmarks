...
--jars /home/hduser/.ivy2/cache/org.apache.kafka/kafka_2.11/jars/kafka_2.11-0.11.0.0.jar,\
...
/home/hduser/.ivy2/cache/org.apache.spark/spark-streaming-kafka-0-8_2.11/jars/spark-streaming-kafka-0-8_2.11-2.2.0.jar \
--class "benchmarks.wordcount.WordCountByOldAPI" \
--driver-memory 15g \
--driver-cores 4 \
--executor-memory 10g \
--executor-cores 6 \
